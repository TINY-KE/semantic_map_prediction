...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        io.add_argument('--log_dir', default='/scratch/ggeorgak/semantic_grid/logs', help='Directory to store logs')
    ...
    def parse_args(self):
        self.args = self.parser.parse_args()  # 说明类中有一个属性 self.parser，它是一个 argparse.ArgumentParser 对象。
