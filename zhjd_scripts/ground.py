...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        # TODO: 计算 points2D, local3D, ssegs_3

        spatial_labels = 27
        grid_dim = (384, 384)
        cell_size = 0.1
        ego_grid_sseg_3 = map_utils.ground_projection(points2D, local3D, ssegs_3, sseg_labels=spatial_labels,
                                                      grid_dim=grid_dim, cell_size=cell_size)

        # TODO:IMSHOW 单个时间步上的地面投影图
