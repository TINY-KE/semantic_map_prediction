...
## 749实验室
+ 使用ROS接收栅格地图
python main.py --name exploration_3_16.1  --ensemble_dir  path-model/   --log_dir /home/robotlab/semantic-map-prediction/zhjd_logs    --ensemble_size 1    --is_ros  --save_nav_images
python main.py --name exploration_3_16.1  --ensemble_dir  path-model/   --log_dir /home/robotlab/semantic-map-prediction/zhjd_logs    --ensemble_size 1    --is_ros 
+ 完成ros发布
+ 接收地图和frontier
+ 